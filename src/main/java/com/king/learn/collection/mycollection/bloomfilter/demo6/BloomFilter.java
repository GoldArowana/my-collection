 ...
 * Cheat sheet:
 * <p>
 * bitSetSize: total bits
 * counter: expected insertions
 * funtions: number of hashes per element
 * b: bitSetSize/counter, bits per insertion
 * p: expected false positive probability
 * <p>
 * 1) Optimal funtions = b * ln2
 * 2) p = (1 - e ^ (-kn/bitSetSize))^funtions
 * 3) For optimal funtions: p = 2 ^ (-funtions) ~= 0.6185^b
 * 4) For optimal funtions: bitSetSize = -nlnp / ((ln2) ^ 2)
 *
