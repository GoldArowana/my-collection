...
import com.king.learn.collection.mycollection.bloomfilter.demo7.allocator.Allocator;
...
public class BloomFilter implements Closeable {
    ...
    // One caveat is that the size() method is O(counter) time, so we keep an independent size counter.
