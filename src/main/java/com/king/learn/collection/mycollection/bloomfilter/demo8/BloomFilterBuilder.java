...
import com.king.learn.collection.mycollection.bloomfilter.demo8.hashing.DefaultHashProvider;
import com.king.learn.collection.mycollection.bloomfilter.demo8.hashing.HashProvider;
...
public class BloomFilterBuilder<E> {
    ...
    /**
     * Set the logical size of the filter. In common publications called <i>bitSetSize</i>.
     *
