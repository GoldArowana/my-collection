...
public interface BloomFilter<T> extends Cloneable, Serializable {
    ...
    /**
     * Return the size of the Bloom filter, i.e. the number of positions in the underlyling bit vector (called bitSetSize in the
     * literature).
     *
    ...
    /**
     * Returns the expected number of elements (called counter in the literature)
     *
    ...
    /**
     * Returns the number of hash functions (called funtions in the literature)
     *
    ...
    /**
     * Returns the funtions hash values for an inputs element in byte array form
     *
