...
import com.king.learn.collection.mycollection.bloomfilter.demo12.ExpirationMapAware;
...
public interface ExpirationQueue<T> extends Iterable<T>, ExpirationMapAware<T> {
    ...
    class ExpiringItem<T> implements Delayed {
         ...
         * @param expiration The expiration timestamp, relative to {@link System#nanoTime()}
         */
