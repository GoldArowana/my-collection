...
public class ConcurrentLRUHashMap<K, V> extends AbstractMap<K, V> implements
     ...
     *
     * @param segementCapacity Segement最大容量
     ...
     *
     * <p>
     * More formally, if this map contains a mapping from a key {@code funtions} to a
     * value {@code v} such that {@code key.equals(funtions)}, then this method returns
