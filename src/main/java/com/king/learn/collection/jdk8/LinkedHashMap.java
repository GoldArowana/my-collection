 ...
 * chaotic ordering provided by {@link com.king.learn.collection.jdk8.HashMap} (and {@link com.king.learn.collection.jdk8.Hashtable}),
...
public class LinkedHashMap<K, V>
        extends com.king.learn.collection.jdk8.HashMap<K, V>
        implements Map<K, V> {
     ...
     */
    static class Entry<K, V> extends com.king.learn.collection.jdk8.HashMap.Node<K, V> {
