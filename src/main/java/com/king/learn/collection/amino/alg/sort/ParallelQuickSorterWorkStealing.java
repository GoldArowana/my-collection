...
package com.king.learn.collection.amino.alg.sort;

import com.king.learn.collection.amino.pattern.internal.DynamicWorker;
import com.king.learn.collection.amino.pattern.internal.MasterWorker;
import com.king.learn.collection.amino.pattern.internal.MasterWorkerFactory;
import com.king.learn.collection.amino.pattern.internal.WorkQueue;
...
public class ParallelQuickSorterWorkStealing extends QuickSorter {
    ...
    /**
     * @param data is the byte array to be sorted in an ascending order using
     *             quicksort
    ...
    /**
     * @param data is the byte array to be sorted in a descending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the character array to be sorted in an ascending order
     *             using quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the character array to be sorted in a descending order
     *             using quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the short array to be sorted in an ascending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the short array to be sorted in a descending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the int array to be sorted in an ascending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the int array to be sorted in a descending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the long array to be sorted in an ascending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the long array to be sorted in a descending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the float array to be sorted in an ascending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the float array to be sorted in a descending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the double array to be sorted in an ascending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param data is the double array to be sorted in a descending order using
     *             quicksort
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    private class ByteSortUpWorker implements
        ...
        /**
         * @param w  is the ByteWorkPacket, contain data to be sorted in an
         *           ascending order
    ...
    private class ByteSortDownWorker implements
        ...
        /**
         * @param w  is the ByteWorkPacket, contain data to be sorted in a
         *           descending order
         * @param wq is the work queue
         */
        public Integer run(ByteWorkPacket w, WorkQueue<ByteWorkPacket> wq) {
    ...
    private class ChaqsortUpUpWorker implements
        ...
        /**
         * @param w  is the CharWorkPacket, contain data to be sorted in an
         *           ascending order
         * @param wq is the work queue
         */
    ...
    private class CharSortDownWorker implements
        ...
        /**
         * @param w  is the CharWorkPacket, contain data to be sorted in a
         *           descending order
         * @param wq is the work queue
         */
        public Integer run(CharWorkPacket w, WorkQueue<CharWorkPacket> wq) {
    ...
    private class ShortSortUpWorker implements
        ...
        /**
         * @param w  is the ShortWorkPacket, contain data to be sorted in an
         *           ascending order
         * @param wq is the work queue
         */
    ...
    private class ShortSortDownWorker implements
        ...
        /**
         * @param w  is the ShortWorkPacket, contain data to be sorted in a
         *           descending order
         * @param wq is the work queue
         */
        public Integer run(ShortWorkPacket w, WorkQueue<ShortWorkPacket> wq) {
    ...
    private class IntSortUpWorker implements
        ...
        /**
         * @param w  is the IntWorkPacket, contain data to be sorted in an
         *           ascending order
         * @param wq is the work queue
         */
    ...
    private class IntSortDownWorker implements
        ...
        /**
         * @param w  is the IntWorkPacket, contain data to be sorted in a
         *           descending order
         * @param wq is the work queue
         */
        public Integer run(IntWorkPacket w, WorkQueue<IntWorkPacket> wq) {
    ...
    private class LongSortUpWorker implements
        ...
        /**
         * @param w  is the LongWorkPacket, contain data to be sorted in an
         *           ascending order
         * @param wq is the work queue
         */
    ...
    private class LongSortDownWorker implements
        ...
        /**
         * @param w  is the LongWorkPacket, contain data to be sorted in a
         *           descending order
         * @param wq is the work queue
         */
        public Integer run(LongWorkPacket w, WorkQueue<LongWorkPacket> wq) {
    ...
    private class FloatSortUpWorker implements
        ...
        /**
         * @param w  is the FloatWorkPacket, contain data to be sorted in an
         *           ascending order
         * @param wq is the work queue
         */
    ...
    private class FloatSortDownWorker implements
        ...
        /**
         * @param w  is the FloatWorkPacket, contain data to be sorted in a
         *           descending order
         * @param wq is the work queue
         */
        public Integer run(FloatWorkPacket w, WorkQueue<FloatWorkPacket> wq) {
    ...
    private class DoubleSortUpWorker implements
        ...
        /**
         * @param w  is the DoubleWorkPacket, contain data to be sorted in an
         *           ascending order
         * @param wq is the work queue
         */
    ...
    private class DoubleSortDownWorker implements
        ...
        /**
         * @param w  is the DoubleWorkPacket, contain data to be sorted in a
         *           descending order
         * @param wq is the work queue
         */
        public Integer run(DoubleWorkPacket w, WorkQueue<DoubleWorkPacket> wq) {
