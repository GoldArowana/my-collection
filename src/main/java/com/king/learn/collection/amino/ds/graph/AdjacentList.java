 ...
 * storing graph.
 *
 * @param <E> Type of elements contained in AdjacentList
 * @author Zhi Gan
 */
public class AdjacentList<E> implements Comparable<AdjacentList<E>> {
     ...
     *
     * @param head the head node of this adjacent list
     */
     ...
     *
     * @param node   the node connected with the head node of this adjacent list
     ...
     *
     * @param n the node with edges to be removed
