...
package com.king.learn.collection.amino.ds.lockfree;

import com.king.learn.collection.amino.utility.Parallel;
import com.king.learn.collection.amino.utility.ParallelType;
...
public class LockFreeSet<E> implements Set<E> {
     ...
     *
     * @param expectedSize the estimated size of set
     * @param loadFactor   average load factor. Number of dummy nodes will expand 2X if
    ...
    /**
     * @param expectedSize expected set size.
     */
     ...
     *
     * @param bucket hash value of working element
     ...
     *
     * @param bucket to find parent of this bucket
     * @param bSize  how many bits are used to form the bucket
     ...
     *
     * @param o     Searching element
     * @param start start position
     * @param hash  Hash value of parameter <code>o</code>
     ...
     * Thread Safe
     *
     * @param e     the HashLinkNode which contains an element to add.
     ...
     * @param start start position of searching
     * @param hash  hash code of parameter <code>e</code>. It's here for saving
     *              cost of hashing
     ...
     * @param hash  hash value of parameter <code>o</code>. It's used to save
...
class HashLinkNode<E> implements Comparable<HashLinkNode<E>> {
     ...
     *
     * @param dummykey key for dummy node
     ...
     * Compare to key.
     *
     * @param objKey the key to compare
