...
public interface Scanner {
     ...
     * @param a     The array to search.
     * @param v     The value to search for.
     * @param index The starting index for the search (exclusive, searching
     *              backward).
     * @return The index of the occurrence or a negative value if not found.
     */
     ...
     * @param a    The array to search.
     * @param v    The value to search for.
     * @param from starting index for search (inclusive)
     * @param to   ending index for search (exclusive)
     * @return The index of the an occurrence or a negative value if not found.
     */
     ...
     *
     * @param a    The array to search.
     * @param v    The sequence to search for.
     * @param r    The replacement sequence.
     * @param from starting index for search (inclusive)
     * @param to   ending index for search (exclusive)
     * @return The number of occurrences found and replaced.
     */
