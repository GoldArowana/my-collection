...
package com.king.learn.collection.amino.alg.parallelprefix;
 ...
 * elements.
 *
 * @param <T> Element type of array, if array is a non-primitive type.
...
public class ThreadedParallelPrefix<T> extends AbstractParallelPrefix<T> {
    ...
    /**
     * @param nthreads Number of threads to use in parallelizing the scan operation.
     */
    ...
    /**
     * @param size minimum size of array for non-serial scan to be used.
     */
    ...
    public class PartialReduction {
        ...
        /**
         * @param n number of worker threads to use in the reduction
         */
         ...
         * @param reducedArray contains intermediate reduction results
        ...
        public int[] reduce(final int[] inputArray, final int[] reducedArray,
                            final BinaryOp<T> op) {
            int numThreads = com.king.learn.collection.amino.Runtime.reserveThreads(numOfThreads);
         ...
         *
         * @param partialReduction partial reductions from a previous scan
         * @param outputArray      destination array containing intermediate results
         * @param op               modifying function
         */
        public void modify(final int[] partialReduction,
            ...
            com.king.learn.collection.amino.Runtime.releaseThreads(numThreads);
        }
