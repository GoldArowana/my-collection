...
package com.king.learn.collection.amino.ds.graph;
...
public interface Graph<E> extends Collection<E>, Cloneable {
     ...
     *
     * @param start  value in start node. A new node will be added to graph is this
     *               value is not in graph yet.
     * @param end    value in end node. A new node will be added to graph is this
     *               value is not in graph yet.
     ...
     *
     * @param start  start node. A new node will be added to graph is this value is
     *               not in graph yet.
     * @param end    end node. A new node will be added to graph is this value is
     *               not in graph yet.
     * @param weight weight of this edge
     * @return true if the operation is successful
     */
