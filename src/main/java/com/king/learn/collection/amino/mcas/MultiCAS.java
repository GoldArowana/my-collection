...
final class MultiCAS {
     ...
     *
     * @param nAddr  number of memory field to be compare and set
     * @param obj    array of object address
     * @param offset array of offset for every object
     * @param e      array of expected value
     * @param n      array of new value
...
//        addressSort(d, nAddr);
     ...
     *
     * @param d     mcas descriptor
     * @param nAddr number of memory address to be sorted
     */
     ...
     *
     * @param obj    Object be read
     * @param offset offset of field in object
     * @return read value
     */
     ...
     * the ABA problem.
     *
     * @param obj    object be ccas
     * @param offset file offset of object
     ...
     *
     * @param obj    obejct read
     * @param offset field offset of object
     * @return object read
     */
    ...
    private static class MCASDesc {
         ...
         * Constructor.
         *
         * @param nAddr  Number of memory address to multi-cas.
         * @param obj    Array of objects. Because in Java, memory address cannot
         *               be access directly, use object address and offset of field
         *               in the object instead.
         * @param offset Array of offset from object.
         * @param e      Expected values.
         * @param n      New values.
         */
