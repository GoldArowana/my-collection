...
package com.king.learn.collection.amino.alg.scan;
...
public class ParallelScanner extends DefaultScanner {
    ...
    public ParallelScanner() {
        numberThreads = com.king.learn.collection.amino.Runtime.getMaxAvailableWorkerThreads();
    }
    ...
    public int[] findAll(final byte[] a, final byte v, int from, int to) {
        ...
        final int numThreads = com.king.learn.collection.amino.Runtime.reserveThreads(numberThreads);
