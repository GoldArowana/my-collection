...
class SerialScanner extends AbstractScanner {
     ...
     * @param to   The ending index for the search.
     ...
     * @param a    The array to search.
     * @param v    The value to search for.
     * @param from The starting index for the search (exclusive, searching
     *             backward).
     * @param to   The ending index for the search (exclusive, searching
     *             backward).
     * @return The index of the occurrence or a negative value if not found.
     */
