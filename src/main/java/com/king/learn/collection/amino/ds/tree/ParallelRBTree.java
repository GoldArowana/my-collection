...
package com.king.learn.collection.amino.ds.tree;


import com.king.learn.collection.amino.pattern.internal.Doable;
...
public class ParallelRBTree<E> {
    ...
    private class RelaxedBalancer {
         ...
         *
         * @param node node which has REMOVAL request
         */
         ...
         *
         * @param node node which has a UP_IN request
         */
         ...
         *
         * @param node node and its sibling has UP_OUT request
         */
