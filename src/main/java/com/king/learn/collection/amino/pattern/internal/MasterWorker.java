...
package com.king.learn.collection.amino.pattern.internal;
...
public interface MasterWorker<S, T> {
     ...
     * </ul>
     * @throws TimeoutException     If the specified timeout period expired before completion of
     *                              all work items.
     * @throws InterruptedException If execution of any of the threads was interrupted.
     * @throws ExecutionException   If any of the worker threads encounted some runtime
     *                              exception.
     */
