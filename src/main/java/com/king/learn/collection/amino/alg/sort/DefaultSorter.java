...
public class DefaultSorter extends AbstractSorter {
    ...
    /**
     * @param <T>  data type
     * @param a    is the array of Comparable objects to be sorted in a
     *             descending order
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param <T>  data type
     * @param a    is the List of Comparable objects to be sorted in a descending
     *             order
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param <T>  data type
     * @param a    is an array of Comparable objects to be sorted in an ascending
     *             order
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
    ...
    /**
     * @param <T>  data type
     * @param a    is a List of Comparable objects to be sorted in an ascending
     *             order
     * @param from is the start index of array to be sorted
     * @param to   is the end index of array to be sorted
     */
     ...
     * @param a    is the array to be sorted, based on which the permuted index
     *             vector is generated
