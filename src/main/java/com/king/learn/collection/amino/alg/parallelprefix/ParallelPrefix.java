 ...
 *
 * @param <T> Generic type for use if array is of non-primitives. Otherwise it
 *            is unused.
 * @author donawa
 */
public interface ParallelPrefix<T> {
     ...
     *
     * @param inputArray  Single dimension input array
     * @param outputArray Single dimension destination array. Can be the same as
     *                    inputArray
     ...
     * {a[0],op(a[0],a[1]),op(a[1],a[2]),...,op(a[n-1],a[n])}
     *
     * @param array       Single dimension input array
     * @param outputArray Single dimension destination array. Can be the same as
     *                    inputArray
     * @param op          binary operator
     */
