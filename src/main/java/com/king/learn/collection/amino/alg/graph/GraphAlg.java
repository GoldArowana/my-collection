 ...
 *
 */
package com.king.learn.collection.amino.alg.graph;

import com.king.learn.collection.amino.ds.graph.*;
...
public final class GraphAlg {
	 ...
	 * @param graph      directed graph to compute strong components. The graph will
	 *                   not be modified
	 * @param threadPool the thread pool used to do computation
	 ...
	 *
	 * @param <E>        value type of the node in the target graph
	 * @param graph      undirected graph to compute connected components. The graph
	 ...
	 * @throws ExecutionException   Exception thrown when attempting to retrieve the result of a
	 ...
	 * @param heap heap
	 * @param node node in the heap whose value has changed
	 */
	...
	private static class ConnectedComponents<E> {
		 ...
		 * @param thread_num number of threads to compute strong components if
	...
	private static class StrongComponents<E> {
		 ...
		 * Constructor.
		 *
		 * @param dg Target directed graph.
		 *           <p>
		 *           the number of threads to compute components will be determined at
		 *           runtime
		 */
		 ...
		 *
		 * @param dg         Target directed graph.
		 * @param numThreads number of threads to compute strong components if
		 ...
		 *
		 * @param dg    Target directed graph.
		 * @param nodes only this set of nodes to search in target directed graph.
