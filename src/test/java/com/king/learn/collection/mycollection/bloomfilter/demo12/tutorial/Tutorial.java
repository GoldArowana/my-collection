package com.king.learn.collection.mycollection.bloomfilter.demo12.tutorial;

import com.google.gson.JsonElement;
import com.king.learn.collection.mycollection.bloomfilter.demo12.*;
import com.king.learn.collection.mycollection.bloomfilter.demo12.json.BloomFilterConverter;
import com.king.learn.collection.mycollection.bloomfilter.demo12.memory.CountingBloomFilterMemory;
import com.king.learn.collection.mycollection.bloomfilter.demo12.redis.RedisBFTest;
...
//        BFHashUniformity.testHashing();
    ...
    public static void regularBF() {
        ...
        BloomFilter<Integer> bf2 = new FilterBuilder()
                ...
                .hashFunction(HashProvider.HashMethod.Murmur3) //our hash
                .buildBloomFilter();
    ...
    public static void testPerformance() throws UnknownHostException, IOException {
        ...
        BloomFilter<String> bf = new FilterBuilder(100_000, 0.01).hashFunction(HashProvider.HashMethod.Murmur3).buildBloomFilter();
