...
import static com.king.learn.collection.mycollection.bloomfilter.demo12.helper.Helper.createCountingRedisFilter;
...
public class CountingBFTest {
    ...
    private CountingBloomFilter<String> createFilter(String name, int n, double p, HashProvider.HashMethod hm) {
        if (!redis) {
    ...
    public void testCardinality() {
        ...
        int elements = 100;
        int range = 20;
        CountingBloomFilter<String> b = createFilter(name + "normal", n, p, HashProvider.HashMethod.MD5);
        Random r = new Random();
