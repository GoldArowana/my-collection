...
public class BloomFilterTest {
    ...
    public void testMultiThreadedAddAndRemove() {
        ...
        BloomFilter<String> filter = createFilter(name, 100_000, 0.001, HashProvider.HashMethod.Murmur2);
        int rounds = 100;
    ...
    public void normalTest() {
        int n = 26;
        double p = 0.01;
        BloomFilter<String> b = createFilter(name, n, p, HashProvider.HashMethod.MD5);
        b.add("Käsebrot");
        b.add("ist");
        b.add("ein");
        b.add("gutes");
    ...
    public void addAllTest() {
        ...
        BloomFilter<String> b1 = createFilter(name + "1", n, p, HashProvider.HashMethod.MD5);
        BloomFilter<String> b2 = createFilter(name + "2", n, p, HashProvider.HashMethod.MD5);
        BloomFilter<String> b3 = createFilter(name + "3", n, p, HashProvider.HashMethod.Murmur2);
