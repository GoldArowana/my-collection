package com.king.learn.collection.mycollection.bloomfilter.demo12.memory;
...
public class CountingBloomFilterMigrateTest {
    ...
    public void setUp() throws Exception {
        ...
        cbf1 = constructor.newInstance(configure(1000, 0.02, HashProvider.HashMethod.MD5).countingBits(countingBits));
        cbf2 = constructor.newInstance(configure(1000, 0.02, HashProvider.HashMethod.MD5).countingBits(countingBits));
    }
