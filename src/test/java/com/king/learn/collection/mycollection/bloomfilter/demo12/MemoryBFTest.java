...
import static com.king.learn.collection.mycollection.bloomfilter.demo12.helper.Helper.createCountingFilter;
import static com.king.learn.collection.mycollection.bloomfilter.demo12.helper.Helper.createFilter;
...
public class MemoryBFTest {
    ...
    public void comparison() {
        ...
        int m = 10000;
        int k = 10;
        for (HashProvider.HashMethod hm : HashProvider.HashMethod.values()) {
    ...
    public void MD5performance() {
        int m = 100;
        int k = 1000000;
        BloomFilter<String> b = createFilter(m, k, HashProvider.HashMethod.MD5);
    ...
    public void SHAperformance() {
        int m = 100;
        int k = 1000000;
        BloomFilter<String> b = createFilter(m, k, HashProvider.HashMethod.SHA512);
        long begin = System.nanoTime();
        long[] observed = new long[m];
        int[] hashValues = b.hash("Performance!");
        for (int i : hashValues) {
    ...
    public void normalPerformance() {
        ...
        int n = 100000;
        double p = 0.02;
        BloomFilter<String> b = createFilter(n, p, HashProvider.HashMethod.MD5);
        CountingBloomFilter<String> cb = createCountingFilter(n, p, HashProvider.HashMethod.MD5);
    ...
    public void serializeBloomFilter() throws IOException, ClassNotFoundException {
        ...
        BloomFilter<String> fbf = createFilter(1000, 0.02, HashProvider.HashMethod.MD5);
        ...
        CountingBloomFilterMemory<String> cbf = new CountingBloomFilterMemory<>(new FilterBuilder(1000, 0.2).hashFunction
                (HashProvider.HashMethod.MD5).countingBits(countingBits).complete());
