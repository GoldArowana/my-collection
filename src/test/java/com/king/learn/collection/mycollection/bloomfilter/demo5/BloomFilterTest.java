...
public class BloomFilterTest {
    ...
    public void testConstructorCNK() throws Exception {
        System.out.println("BloomFilter(c,counter,funtions)");
    ...
    public void testExpectedFalsePositiveProbability() {
        ...
        double expResult = 0.00819; // bitSetSize/counter=10, funtions=7
